...
def test_bi_gram(data):
    ...
    test = ['Technopolis plans', 'plans develop', 'develop stages', 'stages area', 'area less', 'less 100,000', '100,000 square', 'square meters', 'meters order', 'order host', 'host companies', 'companies working', 'working computer', 'computer technologies', 'technologies telecommunications']
    for n_gram in result:
...
def test_tri_gram(data):
    ...
    test = ['Technopolis plans develop', 'plans develop stages', 'develop stages area', 'stages area less', 'area less 100,000', 'less 100,000 square', '100,000 square meters', 'square meters order', 'meters order host', 'order host companies', 'host companies working', 'companies working computer', 'working computer technologies', 'computer technologies telecommunications']
    for n_gram in result:
