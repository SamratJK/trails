...
a = (
    ...
    [
        ...
        ("VIRGINIA service", 2),
        ("service Virginia", 2),
        ("Virginia Department", 2),
        ("Department Social", 2),
        ("Social Services", 2),
        ("Services provided", 2),
        ("provided partnership", 2),
        ("partnership Council", 2),
    ],
    [
        ("211 VIRGINIA service", 2),
        ("VIRGINIA service Virginia", 2),
        ("service Virginia Department", 2),
        ("Virginia Department Social", 2),
        ("Department Social Services", 2),
        ("Social Services provided", 2),
        ("Services provided partnership", 2),
        ("provided partnership Council", 2),
        ("Travel Tourism Site", 1),
        ("Tourism Site Vermont", 1),
    ],
)
